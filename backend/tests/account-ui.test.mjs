...
assert.match(html, /V102\.8\.2 adds reliable timetable editing and selected-session updates/);
...
console.log("V102.8.2 unified account UI compatibility tests passed.");
