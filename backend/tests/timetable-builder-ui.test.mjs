...
assert.match(adminHtml, /id="ttb-session-day"/);
...
assert.match(adminHtml, /id="ttb-session-group"/);
assert.match(adminHtml, /id="ttb-session-teacher"/);
assert.match(adminHtml, /id="ttb-session-zoom"/);
assert.match(adminHtml, /m4l-timetable-builder\.js\?v=101\.4/);
...
assert.match(styles, /m4l-22-timetable-builder\.css\?v=101\.4/);
