...
assert.match(adminHtml, /id="ttb-session-lessons"/);
assert.match(adminHtml, /data-ttb-action="add-session-lesson"/);
assert.match(adminHtml, /id="ttb-save-session"/);
assert.match(adminHtml, /id="timetable-session-message"/);
assert.match(adminHtml, /m4l-timetable-builder\.js\?v=101\.4\.2/);
...
assert.match(builderJs, /lessons/);
assert.match(builderJs, /renderTimetableSessionLessons/);
assert.match(builderJs, /collectTimetableSessionLessons/);
assert.match(builderJs, /addTimetableSessionLesson/);
assert.match(builderJs, /removeTimetableSessionLesson/);
assert.match(builderJs, /ttb-session-lesson-subject/);
assert.match(builderJs, /ttb-session-lesson-module/);
assert.match(builderJs, /ttb-session-lesson-teacher/);
assert.match(builderJs, /ttb-session-lesson-zoom/);
...
assert.match(styles, /m4l-22-timetable-builder\.css\?v=101\.4\.2/);
...
assert.match(builderCss, /\.timetable-session-lesson-grid/);
