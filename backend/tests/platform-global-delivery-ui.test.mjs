...
assert.match(adminHtml, /m4l-global-course-scheduler\.js\?v=102\.12\.8/);
...
assert.match(styles, /m4l-28-global-course-scheduler\.css\?v=102\.12\.8/);
...
console.log("V102.12.8 responsive Global Course Scheduler setup UI checks passed.");
