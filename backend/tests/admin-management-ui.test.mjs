...
assert.match(adminHtml, /styles\.css\?v=103\.1\.0\.1/);
...
assert.match(manageAdminsJs, /function getAdminRoleLabel\(role\)/);
assert.match(manageAdminsJs, /value="SENIOR">SENIOR TEACHER<\/option>/);
