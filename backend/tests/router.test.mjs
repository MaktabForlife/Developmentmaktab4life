...
assert.deepEqual(ROUTE_PATHS, expectedPaths, "The modular router must retain existing routes and include the V102.12.6 Academic Calendar and batch timetable routes");
