...
const freeEvents = buildGlobalCourseEvents(freePlatform, { AccountID: "ACCOUNT1", Active: true }, { isGlobalAdmin: false, week });
...
const paidLabel = buildGlobalCourseEvents(paidPlatform, { AccountID: "ACCOUNT1", Active: true }, { isGlobalAdmin: false, week });
...
const subscriberEvents = buildGlobalCourseEvents(subscriberPlatform, { AccountID: "ACCOUNT1", Active: true }, { isGlobalAdmin: false, week });
...
const teacherEvents = buildGlobalCourseEvents(teacherPlatform, { AccountID: "ACCOUNT1", Active: true }, { isGlobalAdmin: false, week });
...
const cancelledEvents = buildGlobalCourseEvents(cancelledPlatform, { AccountID: "ACCOUNT1", Active: true }, { isGlobalAdmin: false, week });
...
console.log("V102.12 Academy timetable visibility, redaction and Zoom authorization tests passed.");
